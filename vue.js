...
const App = {
  data() {
    return {
      ...
      stepsActive: [1], // 1-текст просматривали (индекс соответствует индуксу  steps). Начально позиция 1 на экране
      planNew: 0, // 1-нажать на кнопку "Начать заново"
    }
  },
  ...
  computed: {
    prevMove() {  // 2. выключена ли кнопка назад
      return this.activeIndex>0 ? false : true
    },
    nextText() {  // 3. находимся ли мы на последнем шаге
